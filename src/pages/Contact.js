        ...
        <div className="relative z-10 grid md:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <p className="reveal d2 text-zinc-400 leading-relaxed mb-8">
              Have a project in mind or need a MERN Stack developer? I'm always
              open to discussing new opportunities, freelance projects, and
            ...
            <div className="reveal d3 flex flex-col gap-4">
              ...
              >
                ...
                <span className="text-sm">maheshwariharesh060@gmail.com</span>
              </a>
              <a
                href="https://linkedin.com/in/maheshwari-harish-00a537252/"
              ...
              >
                ...
                <span className="text-sm">linkedin.com/MaheshwariHaresh</span>
              </a>
              <a
              ...
              >
                ...
                <span className="text-sm">github.com/MaheshwariHaresh</span>
              </a>
            </div>
          </div>
