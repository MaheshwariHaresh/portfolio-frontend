...
function BlogArticle() {
  ...
  return (
    ...
    >
      <style>{`*,*::before,*::after{box-sizing:border-box;}html{font-family:'DM Sans',sans-serif;}h1,h2,h3,h4,h5,h6{font-family:'PT Sans',sans-serif;}::-webkit-scrollbar{width:5px;}::-webkit-scrollbar-track{background:transparent;}::-webkit-scrollbar-thumb{background:#FF6B2B;border-radius:99px;}body{transition:background-color .3s,color .3s;}body::before{content:'';position:fixed;inset:0;background-image:url("data:image/svg+xml,%3Csvg viewBox='0 0 256 256' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='n'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23n)' opacity='0.04'/%3E%3C/svg%3E");pointer-events:none;z-index:0;opacity:.4;}.nav-link{position:relative;}.nav-link::after{content:'';position:absolute;bottom:-2px;left:0;width:0;height:1.5px;background:currentColor;transition:width .25s cubic-bezier(.4,0,.2,1);}.nav-link:hover::after{width:100%;}.btn-primary{position:relative;overflow:hidden;}.btn-primary::after{content:'';position:absolute;top:0;left:-100%;width:60%;height:100%;background:rgba(255,255,255,.18);transform:skewX(-20deg);transition:left .4s cubic-bezier(.4,0,.2,1);}.btn-primary:hover::after{left:160%;}[x-cloak]{display:none!important;}.photo-frame{position:relative;overflow:hidden;background:#e4e4e7;}.photo-frame img{width:100%;height:100%;object-fit:cover;display:block;}.prose-article h2{font-family:'PT Sans',sans-serif;font-size:1.6rem;font-weight:700;color:inherit;margin:2.5rem 0 1rem;line-height:1.25;}.prose-article h3{font-family:'PT Sans',sans-serif;font-size:1.2rem;font-weight:700;margin:2rem 0 .75rem;line-height:1.3;}.prose-article p{margin:0 0 1.4rem;line-height:1.8;color:#52525b;}.dark .prose-article p{color:#a1a1aa;}.prose-article ul{margin:0 0 1.4rem 1.5rem;list-style:disc;}.prose-article li{margin-bottom:.4rem;line-height:1.7;color:#52525b;}.dark .prose-article li{color:#a1a1aa;}.prose-article pre{background:#18181b;color:#e4e4e7;border-radius:12px;padding:1.25rem 1.5rem;overflow-x:auto;font-size:.85rem;line-height:1.7;margin:0 0 1.6rem;}.prose-article code:not(pre code){background:#f4f4f5;color:#FF6B2B;padding:.15em .4em;border-radius:4px;font-size:.875em;}.dark .prose-article code:not(pre code){background:#27272a;}.prose-article blockquote{border-left:3px solid #FF6B2B;padding:.75rem 1.25rem;margin:0 0 1.6rem;background:#fff7f4;border-radius:0 8px 8px 0;}.dark .prose-article blockquote{background:#27272a;}.prose-article blockquote p{color:#52525b;font-style:italic;margin:0;}.dark .prose-article blockquote p{color:#a1a1aa;}.prose-article a{color:#FF6B2B;text-decoration:underline;text-underline-offset:3px;}.prose-article hr{border:none;border-top:1px solid #e4e4e7;margin:2.5rem 0;}.dark .prose-article hr{border-top-color:#27272a;}.progress-bar{position:fixed;top:0;left:0;height:3px;background:#FF6B2B;z-index:100;transition:width .1s;}.reveal{opacity:0;transform:translateY(20px);transition:opacity .5s cubic-bezier(.4,0,.2,1),transform .5s cubic-bezier(.4,0,.2,1);}.reveal.visible{opacity:1;transform:translateY(0);}.card{transition:transform .3s cubic-bezier(.4,0,.2,1),border-color .2s;}.card:hover{transform:translateY(-3px);}`}</style>
      ...
      >
        ...
        >
          ...
          >
            ...
            <li>
              <a href="blog.html" className="nav-link text-accent font-medium">
                Blog
              </a>
            </li>
            <li>
        ...
        <article>
          <header className="pt-32 pb-12 max-w-3xl mx-auto px-6">
            ...
            <p className="text-xl text-zinc-500 dark:text-zinc-400 leading-relaxed mb-8">
              After years of fighting specificity wars and unused kilobytes,
              here's what finally convinced me to make the switch — and the
              measurable impact it had on both my workflow and my clients'
              performance scores.
            </p>

            <div className="flex items-center gap-4 py-6 border-t border-b border-zinc-100 dark:border-zinc-900">
              <div className="photo-frame w-12 h-12 rounded-full shrink-0">
                <img
          ...
          <div className="max-w-3xl mx-auto px-6 pb-16 prose-article">
            ...
            <p>
              I spent three years building projects with Bootstrap and Bulma.
              They're great frameworks — I won't pretend otherwise. But the
              longer I used them, the more I found myself fighting the system
              rather than working with it.
            </p>
            <p>
              Every new project started the same way: import the framework,
              immediately override half of it, write a mountain of custom CSS to
              undo the defaults, then spend 40% of dev time debugging
              specificity issues. The final CSS bundle was usually 80–120kb, of
              which maybe 15% was actually used.
            </p>
            <blockquote>
              <p>
                "The moment you start writing <code>!important</code> to
                override a framework's defaults, something has gone
                fundamentally wrong."
              </p>
            </blockquote>
            <h2>What made me give Tailwind a proper shot</h2>
            <p>
              I'd dismissed Tailwind for a long time. The utility-class approach
              looked messy in the HTML, and I was convinced it would make
              templates unreadable. Then a client asked me to maintain an
              existing Tailwind project, and I had no choice.
            </p>
            <p>Two weeks in, I was converted. Here's what changed my mind:</p>
            <ul>
              <li>
                <strong>No context switching.</strong> I stopped bouncing
                between HTML and CSS files. Everything is right there in the
                markup.
              </li>
              <li>
                <strong>Zero specificity wars.</strong> Utility classes are all
                single-level selectors. You never fight the cascade.
              </li>
              <li>
                <strong>Tiny final bundles.</strong> PurgeCSS (now built in)
                means production builds are typically 5–15kb. My average went
                from 110kb to 8kb.
              </li>
              <li>
                <strong>The design system is the config.</strong> Spacing,
                colours, typography — all centralised in{" "}
                <code>tailwind.config.js</code>.
              </li>
            </ul>
            <h2>The real-world performance impact</h2>
            <p>
              I rebuilt a client's marketing site using Tailwind CSS +
              Alpine.js, replacing their WordPress + Bootstrap 4 stack. The
              results after one month were hard to argue with:
            </p>
            <ul>
              <li>
                Lighthouse performance score: <strong>47 → 96</strong>
              </li>
              <li>
                CSS bundle: <strong>118kb → 7kb</strong>
              </li>
              <li>
                Time to first contentful paint: <strong>3.8s → 0.9s</strong>
              </li>
              <li>
                Bounce rate: <strong>-22%</strong>
              </li>
            </ul>
            <h2>What I still miss from traditional frameworks</h2>
            <p>
              It's not all perfect. A few things I still reach for plugins or
              custom components to replace:
            </p>
            <ul>
              <li>
                Pre-built complex components like modals, dropdowns, and
                datepickers
              </li>
              <li>
                Form validation styling (though Alpine.js handles the logic side
                well)
              </li>
              <li>
                Opinionated grid systems — Tailwind's grid is powerful but
                verbose for complex layouts
              </li>
            </ul>
            <p>
              The ecosystem has largely caught up here. Headless UI, Flowbite,
              and Preline cover most of the gaps. And Alpine.js handles the
              interactivity layer beautifully without adding weight.
            </p>
            <h2>My recommendation</h2>
            <p>
              If you're building anything custom — a SaaS product, a portfolio,
              a landing page — Tailwind is the right tool. The initial learning
              curve is about a week. After that, you'll ship faster than you
              ever did before.
            </p>
            <p>
              If you need a WordPress theme or a simple brochure site with
              minimal custom styling, Bootstrap is still perfectly fine. Use the
              right tool for the job.
            </p>
            <hr />
            <p>
              <em>
                If this was helpful, share it with a frontend dev friend who's
                still on Bootstrap 4. 🧡
              </em>
            </p>
          </div>
        </article>
        ...
        <section className="bg-zinc-50 dark:bg-zinc-900/50 py-16">
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <article className="reveal card group bg-white dark:bg-zinc-900 rounded-2xl overflow-hidden border border-zinc-100 dark:border-zinc-800 hover:border-accent transition-colors">
