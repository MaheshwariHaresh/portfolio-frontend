        ...
        <blockquote className="reveal d1 bg-zinc-50 dark:bg-zinc-900 rounded-2xl p-7 border border-zinc-100 dark:border-zinc-800">
          ...
          <footer className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500">CPO, Novu</p>
            </div>
          </footer>
        </blockquote>

        <blockquote className="reveal d2 bg-zinc-900 dark:bg-zinc-800 rounded-2xl p-7 border border-zinc-800">
          <div className="flex gap-0.5 mb-5" aria-label="5 stars">
            {[1, 2, 3, 4, 5].map((i) => (
              <svg
                key={i}
          ...
          <p className="text-zinc-400 text-sm leading-relaxed mb-6 italic">
            ...
            fast, and the final result always exceeds what we imagined. Our best
            hire of 2024."
          </p>
          <footer className="flex items-center gap-3">
            <div className="pf w-10 h-10 rounded-full shrink-0">
            ...
            <div>
              <p className="font-medium text-sm text-white">Thomas Renault</p>
              <p className="text-xs text-zinc-500">Founder, Finlo</p>
            </div>
          </footer>
        </blockquote>
        ...
        <blockquote className="reveal d3 bg-zinc-50 dark:bg-zinc-900 rounded-2xl p-7 border border-zinc-100 dark:border-zinc-800">
          ...
          <footer className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-500">Creative Director, Orea</p>
            </div>
          </footer>
        </blockquote>
      </div>
